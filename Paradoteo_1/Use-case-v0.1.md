...
3. ~~Ο Χρήστης λαμβάνει τακτικά ειδοποίηση στην εφαρμογή ή στο email του από κάποιον καλλιτέχνη ακολουθεί ή το σύστημα~~. (Αυτό δεν χρειάζετα, έχουμε "Εκτέλεση Βασικής Ροής Receive Notifications" σε κάθε αντίστοιχο use case.)
...
3.α.1 Ο Χρήστης επιλέγει την επιλογή "Premium" από το Navigation Panel και πατάει στην επιλογή "Διαχείρηση Premium"
3.α.2 Το σύστημα εμφανίζει στον χρήστη πόσες μέρες μένουν μέχρι την λήξη της συνδρομής του
3.α.3 Ο Χρήστης επιλέγει "Cancel Premium Subscription"
