...
1. Ο Χρήστης επιλέγει από το navigation panel την επιλογή "Playlist" //Show playlists ίσως καλύτερα? Επίσης το navigation panel είναι design, δεν έχει θέση στα use cases
...
4. Το σύστημα ανακτά από το cloud/database όλα τα τραγούδια που ανήκουν σε αυτό το playlist και τα εμφανίζει //Το αν δεν έχει τραγούδια μήπως θα έπρεπε να έχει εναλλακτική ροή που να καλεί το 
                                                                                                               Use-case "Add songs to playlist"?
...
2. Ο Χρήστης επιλέγει τις 3 τελείες δίπλα στον τίτλο του τραγούδιού //Οι 3 τελείες είναι design, καλύτερα είναι "Ανοίγει τις επιλογές" ή κάτι τέτοιο
...
6. Το σύστημα προσθέτει στην Playlist το επιλεγμένο τραγούδι //Κι αν το τραγούδι υπάρχει ήδη στην Playlist?
...
1. Εκτέλεση Βασικής Ροής "Select Playlist"
2. Ο Χρήστης επιλέγει το τραγούδι που θέλει να αφαιρέσει και πατάει τις τρεις τελείες δίπλα στον τίτλο του τραγούδιού //Design
3. Το σύστημα εμφανίζει ένα μενού επιλογών
...
1. Ο Χρήστης επιλέγει την εικόνα προφίλ του //Design, σκέτο προφίλ
...
5. Το σύστημα στέλνει το αίτημα στους Curators //Ίσως να πρέπει να καλούμε το Approve/Reject UserToArtist
...
(θεωρουμε οτι τα recommendations ειναι στην αρχικη οθονη) //Design
1. Ο Χρήστης επιλέγει ένα τραγούδι και πατάει τις τρεις τελείες δίπλα στον τίτλο του τραγούδιού //Design
2. Το σύστημα εμφανίζει ένα μενού επιλογών
3. Ο Χρήστης επιλέγει "Remove from Recommendations"
4. Το σύστημα παύει να εμφανίζει αυτό το τραγούδι στα Recommendations //Χρειάζεται κι άλλη ανάλυση, δεν μπορώ να το προχωρήσω
